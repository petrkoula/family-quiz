...
**Then** I should see a "Spustit" or quick start button
...
**When** I click the "Spustit" button on a quiz card
...
**Given** I clicked "Spustit" on a quiz card
...
**Then** the "Spustit" button should be visually prominent
...
**When** I click "Spustit" on any quiz pack
...
**When** I navigate to the "Spustit" button using Tab key
