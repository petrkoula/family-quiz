@echo off
REM Acceptance Test Runner for Quiz Customization Feature (Windows)
REM
REM Runs the complete acceptance pipeline:
REM 1. Parse spec.md into spec.json IR (using dae_gherkin.py)
...
echo ========================================
echo Quiz Customization Acceptance Pipeline
echo ========================================
echo.
